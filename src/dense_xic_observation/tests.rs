...
fn test_basic_creation() {
    ...
    let obs = DenseXICObservation::new(&dia_data, 200.0, 10, 12, 0, 1, 20.0, &fragment_mz);
...
fn test_optimized_data_creation() {
    ...
    let obs = DenseXICObservation::new(&dia_data, 200.0, 10, 11, 0, 1, 20.0, &fragment_mz);
...
fn test_metadata_storage() {
    ...
    let obs = DenseXICObservation::new(&dia_data, 200.0, 10, 15, 0, 1, 50.0, &fragment_mz);
...
fn test_dense_xic_mz_basic_creation() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 200.0, 10, 12, 0, 1, 20.0, &fragment_mz);
...
fn test_dense_xic_mz_intensity_values() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 200.0, 10, 11, 0, 1, 1000.0, &fragment_mz);
...
fn test_dense_xic_mz_weighted_average() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 250.0, 5, 6, 0, 1, 2000.0, &fragment_mz);
...
fn test_dense_xic_mz_zero_intensity_handling() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 300.0, 0, 2, 0, 1, 2000.0, &fragment_mz);
...
fn test_dense_xic_mz_multiple_fragments() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 200.0, 10, 11, 0, 1, 20.0, &fragment_mz);
...
fn test_dense_xic_mz_single_cycle_single_fragment() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 200.0, 10, 11, 0, 1, 20.0, &[200.0]);
...
fn test_dense_xic_mz_overlapping_tolerance_windows() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 200.0, 10, 11, 0, 1, 1000.0, &[200.0, 200.05]);
...
fn test_dense_xic_mz_out_of_mz_index_range() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 200.0, 10, 11, 0, 1, 20.0, &[100.0]);
...
fn test_dense_xic_mz_exact_tolerance_boundary() {
    ...
    let obs = DenseXICMZObservation::new(&dia_data, 200.0, 10, 11, 0, 1, 400.0, &[200.05]);
